...
\setbeamertemplate{footline}{%
	...
	\begin{minipage}[t][8.125mm][t]{121.5mm}
		...
		\insertshortdate
		\hspace{2.5mm}
		\insertshortauthor %\HECpiedDePage
		\hfill
		\ifdebutSection
...
\include{02-presentation}

% Section Principes de base
\include{03-principes-base}

% Section Organisation d'un document
\include{04-organisation}

% Section Apparence du texte
\include{05-apparence-texte}

% Section B-A-BA des mathématiques
\include{06-b-a-ba-maths}

% Section hecthese
\include{07-hecthese}

% Section modifications
\include{08-modifications}
