...
\begin{frame}[fragile,c]
	...
	\begin{enumerate}
		\item Démarrez votre éditeur de code intégré nouvellement installé.
		\item Créez un nouveau document vierge.
		\item Dans ce document, saisissez le code suivant :
	...
	\end{codesource}
		...
		\item Sauvegardez votre document au format \texttt{.tex}.
	\end{enumerate}
\end{frame}
